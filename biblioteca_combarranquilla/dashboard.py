...
from matplotlib.figure import Figure  # type: ignore[reportMissingModuleSource]

from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg  # type: ignore[reportMissingModuleSource]
